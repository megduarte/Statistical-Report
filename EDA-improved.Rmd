...
tfr_policy_resid |> 
  ACF(.resid) |>
  autoplot() +
  labs( caption = stringr::str_wrap("tfr_sarima_policy = ARIMA(log_TFR ~ small_family_push + big_family_push + pdq() + PDQ( period = 12))"))+
...
TFR_perfect_1 <-singapore_train |>
  model(
    tfr_sarima_policy_1 = ARIMA(log_TFR ~ small_family_push + big_family_push + pdq(2,0,2) + PDQ(period = 12))
  )
...
tfr_perfect1_resid |> 
  ACF(.resid) |>
  autoplot() +
  labs( caption = stringr::str_wrap("tfr_sarima_policy_1 = ARIMA(log_TFR ~ small_family_push + big_family_push + pdq(2,0,2) + PDQ(period = 12))"))+
  theme(plot.caption = element_text(hjust = 0)
  )
```
...
TFR_perfect_2 <-singapore_train |>
  model(
    tfr_sarima_policy_2 = ARIMA(log_TFR ~ small_family_push + big_family_push + pdq(2,0,2) + PDQ(1,0,0, period = 12))
  )
```
...
tfr_perfect2_resid |> 
  ACF(.resid) |>
  autoplot() +
  labs( caption = stringr::str_wrap("tfr_sarima_policy_2 = ARIMA(log_TFR ~ small_family_push + big_family_push + pdq(2,0,2) + PDQ(1,0,0, period = 12))"))+
  theme(plot.caption = element_text(hjust = 0)
  )
```
...
TFR_perfect_3 <-singapore_train |>
  model(
    tfr_sarima_policy_3 = ARIMA(log_TFR ~ small_family_push + big_family_push + pdq(2,1,2) + PDQ( period = 12))
  )
...
tfr_perfect3_resid |> 
  ACF(.resid) |>
  autoplot() +
  labs( caption = stringr::str_wrap("tfr_sarima_policy_3 = ARIMA(log_TFR ~ small_family_push + big_family_push + pdq(2,1,2) + PDQ( period = 12))"))+
  theme(plot.caption = element_text(hjust = 0)
  )
```
