...
TFR_policy_fc |>
  ...
  labs(
    ...
    caption = stringr::str_wrap("Figure 21. Plot of the predictive SARIMA shows that the SARIMA model that takes the government's family planning policies into account, follows the known TFR data very well.", width = 75)
  ) +
  theme(plot.caption = element_text(hjust = 0.5),
        plot.title = element_text(hjust = 0)
  )
