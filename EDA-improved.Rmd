...
```{r}
singapore |> autoplot(difference(log(`Total Fertility Rate (TFR)`))) +
...
```{r}
singapore |> autoplot(difference(log(`Total Live-Births`))) +
...
```{r}
TFR <- difference(log(singapore$`Total Fertility Rate (TFR)`))
                  
TLB <- difference(log(singapore$`Total Live-Births`))
```
